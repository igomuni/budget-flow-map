...
export function TopNSettings({
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="absolute bottom-4 left-4 opacity-70 z-20 bg-white/95 backdrop-blur rounded-lg shadow-lg p-2 flex items-center gap-2 hover:bg-gray-50 transition-colors"
        title="TopN設定"
      >
  ...
  return (
    <div className="absolute bottom-4 left-4 z-20 bg-white/95 backdrop-blur rounded-lg shadow-lg p-4 w-80">
